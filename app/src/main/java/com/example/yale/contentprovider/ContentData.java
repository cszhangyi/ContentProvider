package com.example.yale.contentprovider;
...
/**
 * Created by Yale on 16/6/21.
 */
public class ContentData {
    public static final String AUTHORITY = "com.example.yale.contentprovider";
...
//    public static UriMatcher uriMatcher;
    ...
    public static final class UserTableData implements BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/com.example.yale.teachers";
        // 单一数据的MIME类型字符串应该以vnd.android.cursor.item/开头
        public static final String CONTENT_TYPE_ITME = "vnd.android.cursor.item/com.example.yale.teacher";
        /* 自定义匹配码 */
